export const settings = {
  ...
  sections: {
    ...
    gmail: {
      title: "Tour Emails (Google)",
      description: "Connect Gmail so SwampFindr can send listing tour requests from your account",
      connectButton: "Connect Google",
      connecting: "Redirecting...",
      disconnectButton: "Disconnect Gmail",
      disconnecting: "Disconnecting...",
      connectedLabel: "Connected Google account",
      disconnectedLabel: "Gmail is not connected",
    },
    mfa: {
  ...
  messages: {
    ...
    gmailConnected: "Gmail connected. Tour request emails are now enabled.",
    gmailDisconnected: "Gmail disconnected. Tour request emails are now disabled.",
